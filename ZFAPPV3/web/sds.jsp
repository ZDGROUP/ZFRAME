...
<body>
	<%
		final String reportPath = request.getSession().getServletContext().getRealPath("/ReportRepository/stimul/Dashboards.mrt");
		final String savePath = request.getSession().getServletContext().getRealPath("/ReportRepository/stimul/");
