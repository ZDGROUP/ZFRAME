...
<META HTTP-EQUIV="Access-Control-Allow-Origin" CONTENT="<% out.println(ApplicationInformation.DomainAddressOnWebServer); %>">
    ...
    <script src="ZJBPMS/jquery-1.7.2.min.js" type="text/javascript"></script>
    ...
    <script src="ZJBPMS/icb.mcb.js" type="text/javascript"></script>
      ...
      <script language="Javascript">
        ...
        function showsetting() {
            openWindowsInNewTabNavigationUrl('accessibility.jsp', 'accessibility', 'تنظیمات امنیتی');
        }

        function changePassword() {
            openWindowsInNewTabNavigationUrl('ZBPMS.bpm?ID=726', 'changepassword', 'تغییر کلمه عبور');
        }
...
<form id="form1" runat="server" style="height:100%">
  <input type="hidden" id="scroll" runat="server"/>
    ...
    <div Id="wrapper">
      ...
      <div class="navbar">
          <div class="hamburger">
              <i style="float:left;background-color: #2266e3;font-size: 28px;padding-right: 20px;padding-left: 20px;" class="fa fa-bars " id='menubar'  aria-hidden="true" onclick="HiddenDivRight('open')"></i>
          </div>
...
<!--        <img src='NewWork/images/logo.png' style='float: right;  border-left: 1px solid #f2f2f2;'>-->
        <img src="Images/Control/user2.png"  alt="avatar" style='background: #ffffff4f;border-radius: 100px;'>
                      ...
                      <li>
                        <%
                                    try {
                                        ...
                                        session.setAttribute("LTR", "0");
                                        TreeViewManagement CTreeView = new TreeViewManagement(request, response);
                                        String UserID = session.getAttribute("User_ID").toString();
                                        out.write(CTreeView.loadWorkFlowListInTreeView(Integer.valueOf(UserID), zdg.zframe.configuration.ApplicationInformation.Direction));
                                    } catch (Exception ex) {
        ...
        background-color: #fff;  
                        ...
                        <div id="divformviewer"
                            ...
                            <script>
                                  ...
                                  function HiddenDivTop()
                                    {
                                         var docobject = document.getElementById('containerMenuTop');
                                         if (docobject.style.display == "none" )
                                         {
                                             docobject.style.display = "block";
                                         }
                                         else
                                         {
                                             docobject.style. display = "none";
                                         }
                                    }
                            </script>
                            ...
                            <div>
                                <div id="TBC" name="TBC" class="tab" style="vertical-align:top;" dir="ltr">
                            ...
                            <div id="TABCC" name="TABCC" class="MainClass" style="width:100%;min-height:100%;">
    ...
    //text-align: center;
                ...
                <script type="text/javascript">
                    ...
                    function HiddenDivRight(state) {
                      ...
                      //navbar2.style.marginRight = '';
                        var navbar2 = document.getElementById('PLeft');
                        navbar2.style.marginLeft = '310px';
                      document.getElementById("menubar").setAttribute( "onClick", "HiddenDivRight('close');" ) ;
                      }
                      else{
