                ...
                <tr>                    
                    <td align="Center">
                        ...
                        <div style="text-align: center; background-color: #07103C; color:#F2F2F2; width: 50%; height:25px; font-size: 16px; -webkit-border-top-left-radius: 5px;
                            ...
                            <h4 style="font-family:ZFRAMEFONT;" >Access Manager</h4>
                        </div>
                        <table style="text-align: center; border: 1px solid; border-color: #000; direction: ltr; width: 50%; -webkit-border-bottom-right-radius: 5px;
                            ...
                            <tr>
                                ...
                                <%
                                    ...
                                    String Sys_Accessibility_Level1_ID ="";
                                         ...
                                         zdg.zframe.infrastructure.DataTable Table = CDataProvider.executeDataTable ( "SELECT SYS_OBJECT_ID,SYS_OBJECT_CAPTION FROM SYS_OBJECT WHERE SYS_SYSTEM_ID =" +  ApplicationInformation.System_ID);
                                        ...
                                        DataTable TableControls = CDataProvider.executeDataTable ( mQuery);
                                         ...
                                         DataTable Table3 = CDataProvider.executeDataTable ( "SELECT CANVIEW,CANEDIT,CANDELETE,CANINSERT,CANREPORT,CANEXPORT,SYS_ACCESSIBILITY_LEVEL1_ID FROM SYS_ACCESSIBILITY_LEVEL1 WHERE SYS_OBJECT_ID = " + SELECTOBJECTID + " AND SYS_USERGROUP_ID= " + SELECTGROUPID);
                                ...
                                %>
                                <td style="width:50%;font-family:ZFRAMEFONT">Select Form</td>
                                <td>
                            ...
                            <tr>
                                ...
                                %>
<td style="width:50%;font-family:ZFRAMEFONT">                              Select User Group</td>
                                <td>
                        ...
                        <div style="text-align: center; background-color: #07103C; color:#F2F2F2; width: 50%; height:25px; font-size: 16px; -webkit-border-top-left-radius: 5px;
                             ...
                             border-top-left-radius: 5px;
                             border-top-right-radius: 5px;">
                            <h4 style="font-family:ZFRAMEFONT" >Base Access To From </h4>
                        </div>
                        <table style="text-align: center; border: 1px solid; border-color: #000; direction: ltr; width: 50%; -webkit-border-bottom-right-radius: 5px;
                               -webkit-border-bottom-left-radius: 5px;
                               -moz-border-radius-bottomright: 5px;
                            ...
                            <tr style="background-color: #ddd;">
                                ...
                                <td style="font-family:ZFRAMEFONT">Show </td>

                                <td style="font-family:ZFRAMEFONT">Edit</td>
                                <td style="font-family:ZFRAMEFONT">Delete</td>
                                <td style="font-family:ZFRAMEFONT">Insert</td>
                                <td style="font-family:ZFRAMEFONT">Report</td>
                                <td style="font-family:ZFRAMEFONT">Export</td>
                            </tr>
                            <tr>
                        ...
                        <div style="text-align: center; background-color:#07103C; color:#F2F2F2; width: 50%; height:25px; font-size: 16px; -webkit-border-top-left-radius: 5px;
                             ...
                             border-top-left-radius: 5px;
                             border-top-right-radius: 5px;">
                            <h4 style="font-family:ZFRAMEFONT">Form Access</h4>
                        </div>
                        <table style="text-align: center; border: 1px solid; border-color: #000; direction: ltr; width: 50%; -webkit-border-bottom-right-radius: 5px;
                               -webkit-border-bottom-left-radius: 5px;
                               -moz-border-radius-bottomright: 5px;
                               ...
                               border-bottom-left-radius: 5px;">
                            <tr>
                                <td><input type="submit" id="btn_NotAccess" name="btn_NotAccess" value="Remove Access" style="width: 150px; font-family:ZFRAMEFONT; height: 40px; background-color: #CC0000; color:#fafafa;  font-size: 12px; " /></td>
                                    <% 
                                    ...
                                    %>
                                <td><input type="submit" id="btn_CustomAccess" name="btn_CustomAccess" value="Custom Access" style=" font-family:ZFRAMEFONT;width: 180px; height: 40px; background-color: #0066FF; color:#fafafa; font-size: 12px; " /></td>
                                ...
                                <td><input type="submit" id="btn_FullAccess" name="btn_FullAccess" value="Full Access" style="font-family:ZFRAMEFONT;width: 150px; height: 40px; background-color: #387038; color:#fafafa; font-size: 12px;" /></td>
                                    <% 
                        ...
                        <br>
                        <table style="text-align: center; border: 1px solid; border-color: #000; direction: ltr; width: 50%; border-radius:5px; ">
                            <tr style="background-color: #07103C; color: #fafafa;">
                                <td style="font-family:ZFRAMEFONT">Row Number</td>
                                <td style="font-family:ZFRAMEFONT">Control Name</td>
                                <td style="font-family:ZFRAMEFONT">Can View</td>
                                <td style="font-family:ZFRAMEFONT">Can Edit</td>
                            </tr>
                            ...
                            if (request.getParameter("btn_CustomAccess") != null) 
                    {
                        ...
                        out.println("<div style=\"width: 50%; height: 30px; background-color: #06F; color: #fafafa; text-align: center; font-family: FontYekan; font-size: 20px; border-radius:5px; \">");
                                ...
                                out.println("Submit Custome Access");
                                out.println("</span>");
                        ...
                        if (request.getParameter("btn_FullAccess") != null) 
                {
                    ...
                    out.println("<div style=\"width: 50%; height: 30px; background-color: #387038; color: #fafafa; text-align: center; font-family: FontYekan; font-size: 20px; border-radius:5px; \">");
                            ...
                            out.println("<span  style=\"font-family:ZFRAMEFONT;\" >");
                            out.println("Submit Full Access");
                            out.println("</span>");
                        ...
                        if (request.getParameter("btn_NotAccess") != null) 
                {
                    ...
                    out.println("<div style=\"width: 50%; height: 30px; background-color: #CC0000; color: #fafafa; text-align: center; font-family: FontYekan; font-size: 20px; border-radius:5px; \">");
                            ...
                            out.println("<span style=\"font-family:ZFRAMEFONT;\">");
                            out.println("Submit Remove Access");
                            out.println("</span>");
